/*This is an edited version of the StreamSaver project. In order to get 
it working in React I needed to manually import the web-streams-polyfill 
projectand import the WritableStream function from it. Without doing this 
writeableStreamproperty of the streamSaver object would be undefined.*/

/*!!!!!!!!!!!! If the below comment is deleted the application crashes????*/
...
const test = ((name, definition) => {
  ...
  const streamSaver = ('streamSaver', () => {
    ...
    const streamSaver = {
      ...
      WritableStream: window.WritableStream || WritableStream,
      supported: true,
